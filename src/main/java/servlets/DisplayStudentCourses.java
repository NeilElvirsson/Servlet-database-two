...
@WebServlet(urlPatterns = "/display-student-courses")
public class DisplayStudentCourses  extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        String studentName = (String) req.getAttribute("studentName");
        List<String> studentCourses = (List<String>) req.getAttribute("studentCourses");
        ...
        for (String course : studentCourses) {
            ...
            System.out.println(studentName + course + studentCourses);
        }
